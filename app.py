...
def get_link(res):
    ...
    return re.sub(url_pattern, r'<a href="\1" target="_blank" style="color: blue; text-decoration: underline;">\1</a>', res)
...
def home():
    if request.method == "GET":
        ...
        if "deals" in request.form:
            ...
            deals = vinyls.return_res(sub, sub_deals)
            return render_template("index.html", results=deals)
        else:
